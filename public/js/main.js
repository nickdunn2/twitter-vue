...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-cb288510", module.exports)
  } else {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-c32ee3f0", module.exports)
  } else {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7614ebc6", module.exports)
  } else {
...
var getCurrentUser = exports.getCurrentUser = function getCurrentUser(_ref) {
  ...
  _vue2.default.http.get('api/users/currentuser').then(function (response) {
    dispatch('RECEIVE_CURRENT_USER', response.data);
  });
};

var getAllTweets = exports.getAllTweets = function getAllTweets(_ref2) {
  var dispatch = _ref2.dispatch;

  _vue2.default.http.get('api/tweets').then(function (response) {
    dispatch('RECEIVE_ALL_TWEETS', response.data);
  });
};

var addTweet = exports.addTweet = function addTweet(_ref3, tweet_content) {
...
var deleteTweet = exports.deleteTweet = function deleteTweet(_ref4, tweet) {
  ...
  swal({
    ...
    _vue2.default.http.delete('api/tweets/' + tweet.id).then(function (response) {
      var deletedTweet = response.data;
...
exports.default = new _vuex2.default.Store({
  ...
  mutations: {
    ...
    RECEIVE_CURRENT_USER: function RECEIVE_CURRENT_USER(state, user) {
    ...
    DELETE_TWEET: function DELETE_TWEET(state, deletedTweet) {
